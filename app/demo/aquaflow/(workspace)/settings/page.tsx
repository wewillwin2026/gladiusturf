  ...
  return (
    <div className="flex flex-col gap-6">
      <header className="flex flex-col gap-1">
        <span className="af-eyebrow-muted">Settings</span>
        <h1
      ...
      <section className="af-card grid gap-3 p-5 md:grid-cols-2">
      ...
      <section className="af-card flex flex-col gap-2 p-5">
        <span className="af-eyebrow">Ready to talk to a founder?</span>
        <p
          className="text-[13px] leading-[1.6]"
          style={{ color: "var(--af-text-muted)" }}
        >
          The fastest way to see your real numbers in a workspace like this is
          a 30-minute demo. We&rsquo;ll audit one route&rsquo;s backflow
          compliance on the call.
        </p>
        <Link
          href="/demo?utm_source=aquaflow-demo"
          className="af-btn-primary mt-1 self-start"
        >
