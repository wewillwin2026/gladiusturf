  ...
  return (
    <div className="flex flex-col gap-6">
      <header className="flex flex-col gap-1">
        <span className="bh-eyebrow-muted">Settings</span>
        <h1
      ...
      <section className="bh-card grid gap-3 p-5 md:grid-cols-2">
        ...
        <Field label="Techs" value={String(BRAND.techs)} />
        <Field label="Supervisors" value={String(BRAND.supervisors)} />
      </section>

      <section className="bh-card flex flex-col gap-2 p-5">
        <span className="bh-eyebrow">Ready to talk to a founder?</span>
        <p
          className="text-[13px] leading-[1.6]"
          style={{ color: "var(--bh-text-muted)" }}
        >
          The fastest way to see your real numbers in a workspace like this
          is a 30-minute demo. We&rsquo;ll run a free chemistry-drift audit
          on three of your pools.
        </p>
        <Link
          href="/demo?utm_source=blue-haven-demo"
          className="bh-btn-primary mt-1 self-start"
        >
