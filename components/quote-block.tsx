          ...
          <div className="rounded-3xl border border-bone/10 bg-gradient-to-br from-moss/[0.06] via-transparent to-transparent p-10 md:p-14">
            ...
            <div className="mt-8 flex flex-col items-start gap-6 sm:flex-row sm:items-center">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-moss-bright to-forest font-serif text-lg font-semibold text-forest-deep">
                  RB
                </div>
                <div>
            ...
            <p className="mt-6 text-[11px] uppercase tracking-[0.18em] text-bone/35">
